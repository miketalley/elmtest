		...
		if (_p0.ctor === 'MouseMsg') {
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{count: model.count + 1, event: 'Mouse Click'}),
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{count: model.count + 2, event: 'Key Press'}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html$text(
					_elm_lang$core$Basics$toString(model.event)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$initialModel = {count: 0, event: 'None'};
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Main$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Main$Model = F2(
	function (a, b) {
		return {count: a, event: b};
	});
